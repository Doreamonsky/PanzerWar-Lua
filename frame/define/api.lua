...
WarZoneCaptureZone = CS.ShanghaiWindy.Data.WarZoneCaptureZone
WarZoneModeConfig = CS.ShanghaiWindy.Data.WarZoneModeConfig
...
VehicleComponents = CS.ShanghaiWindy.Core.VehicleComponents
TurretController = CS.ShanghaiWindy.Core.TurretController
MultiInputWrapperManageComponent = CS.ShanghaiWindy.Core.MultiInputWrapperManageComponent
...
ILuaVehicleController = CS.ShanghaiWindy.Core.Lua.ILuaVehicleController
...
HitBoxAPI = CS.ShanghaiWindy.Core.API.HitBoxAPI
...
InternalModuleAPI = CS.ShanghaiWindy.Core.API.InternalModuleAPI
...
IVehicleController = CS.ShanghaiWindy.Core.IVehicleController
