...
function M:InitUI(root)
    ...
    --- @type GameObject
    self.vPointTemplate = root:Find("VerticalLayout/PointTemplate/#obj_PointTemplate").gameObject
    --- @type GameObject
    self.vZoneList = root:Find("VerticalLayout/PointTemplate/#obj_ZoneList").gameObject
end
